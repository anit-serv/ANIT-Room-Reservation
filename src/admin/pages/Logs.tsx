...
const ACTION_LABELS: Record<string, { label: string; icon: string; color: string }> = {
  ...
  'reservation.cancel':                 { label: '予約キャンセル(農部生協)', icon: 'cancel',          color: 'var(--color-danger)' },
  'kobu_reservation.update':            { label: '予約編集(工部室)',         icon: 'edit',            color: 'var(--color-warn)' },
  'kobu_reservation.cancel':            { label: '予約キャンセル(工部室)',   icon: 'cancel',          color: 'var(--color-danger)' },
  'nobu_room_reservation.update':       { label: '予約編集(農部室)',         icon: 'edit',            color: 'var(--color-warn)' },
  'nobu_room_reservation.cancel':       { label: '予約キャンセル(農部室)',   icon: 'cancel',          color: 'var(--color-danger)' },
