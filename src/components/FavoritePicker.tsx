...
export default function FavoritePicker({
  ...
  favorites:  Favorite[]
  onSelect:   (favoriteId: string, name: string, nobuTimeSlot: string | null, kobuTimeSlot: string | null, nobuRoomTimeSlot: string | null) => void
}) {
      ...
      <div className="flex gap-1.5 flex-wrap">
        {favorites.map(f => (
          <button
            ...
            onClick={() => onSelect(f.id, f.name, f.nobuTimeSlot, f.kobuTimeSlot ?? null, f.nobuRoomTimeSlot ?? null)}
          >
